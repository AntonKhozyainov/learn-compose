...
private fun DessertClickerApp(
    ...
    //всякий раз, когда происходит изменение uiState значения,
    //происходит перекомпоновка составных объектов, использующих это gameUiState значение.
    ...
    Scaffold(
        ...
        DessertClickerScreen(
            revenue = dessertUiState.revenue,
            dessertsSold = dessertUiState.dessertsSold,
            dessertImageId = dessertUiState.dessert.imageId,
            onDessertClicked = {
                dessertViewModel.buyTheDessert()
            },
